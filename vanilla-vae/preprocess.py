...
class Loader:
    ...
    def load(self, filepath):
        signal = librosa.load(filepath, 
                              ...
                              mono=self.mono)[0] #to just get the signal and not the sample rate
        return signal
...
class Saver:
    """Saver is responsible to save features and mix the min max values."""
...
class PreprocessingPipeline:
    """PreprocessingPipeline processes audio files in a directory, applying the following steps""
    1. load a file
    2. pad the signal id necessary
    3. extracting log spectrogram from signal
    4. normalize spectrogram
...
if __name__ == "__main__":
    ...
    SPECTROGRAMS_SAVE_DIR = "/Users/gabriel/Documents/2_CODE/FSDD/spectrograms"
    MIN_MAX_VALUES_SAVE_DIR = "/Users/gabriel/Documents/2_CODE/FSDD/"
    FILES_DIR = "/Users/gabriel/Documents/2_CODE/FSDD/recordings"
